...
built from `requirements-lock.txt`, on 2026-08-22 (UTC), Darwin arm64.
...
External tools (for `make pdf`): pandoc + TeX Live pdflatex.
...
make pdf                                  # paper/manuscript.pdf rebuilt
