...
steady-state prevalence. USA300 was documented moving through sexual
networks in men who have sex with men two decades ago, in clusters and
outbreaks --- the same networks doxy-PEP now targets (Diep et al. 2008;
{Jong et al.} 2025). A cross-sectional colonisation endpoint is
structurally blind to clustered transmission, and a low proportion is
precisely what one would expect shortly before an outbreak rather than
