...
more frequent in general practice than reactions to the tetracyclines
({Van der Linden et al.} 1998) --- that doxycycline is not merely an
alternative: for a substantial minority of patients it is the only
remaining oral option. Critically, this choice is made empirically,
...
{Van der Linden, P. et al.} 1998. {``Skin Reactions to Antibacterial
Agents in General Practice.''} \emph{J Clin Epidemiol} 51 (8): 703--8.
