...
preferred first, but sulfonamide allergy is common enough that
doxycycline is not merely an alternative --- for a substantial minority
of patients it is the only remaining oral option. Critically, this
choice is made empirically, before any methicillin result returns. We
therefore treat \emph{S. aureus} as the clinical target throughout,
rather than methicillin-resistant \emph{S. aureus} specifically;
methicillin status is downstream of the decision doxycycline is used to
make.
