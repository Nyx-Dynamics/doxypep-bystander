...
\begin{table}[h]
\centering
\caption{Stream C closed-universe enumeration: twelve included US governmental
surveillance systems and three excluded, each with a stated reason. No included
system captures both doxy-PEP exposure and the \sa{} tetracycline phenotype at a
common population denominator (0/12 join).}
\label{tab:streamc}
\small
...
needs $1.8\times$ the combined male exposure density of the densest US geography
(Washington, D.C., 6\,406 per 100\,000 adult males in 2024), and realistic cells
hundreds of times it. All values regenerate from
\texttt{outputs/feasibility\_plwh\_result.md}. Figures~A--C display the more
restrictive PrEP-only indexing (RR~$\approx$~14--64), which overstates
infeasibility relative to the combined-denominator primary and is retained as a
bound pending figure regeneration.
