...
| 12 | the trial's estimand shift did not propagate to guidance (Table 1; Results, ¶ after propagation table) | coding + Table 1: no guidance document cites the final time-to-event analysis or any hazard ratio; of the two documents revised after its March 2025 online publication (WHO 2026, San Francisco May 2026), **0 of 2** adopted the estimand — both retained a cross-sectional or generic frame | S. aureus / estimand | discharged (dated non-citation; 0/2 post-final framing; corpus demonstrably transmits numbers when it has them) |
